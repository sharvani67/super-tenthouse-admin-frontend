...
const CreateOrder: React.FC = () => {
  ...
  const placeOrder = async () => {
    ...
    try {
      ...
      // Store the cart items for invoice before clearing
      ...
      setShowInvoice(true);
      // Don't clear cart here - it will be shown in invoice
  ...
  // If invoice is shown, display invoice view with cart items
  if (showInvoice && placedOrder) {
    // Use cart items for display (they are still available)
      ...
      <div className="min-h-screen bg-gray-100 py-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div ref={invoiceRef} className="bg-white rounded-xl shadow-2xl overflow-hidden">
            {/* Invoice Header */}
            <div className="bg-gradient-to-r from-[#0c2d67] to-[#1a3f7a] text-white p-6">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <p className="text-blue-200">Date: {orderDate.toLocaleDateString()}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-4">
              {loading ? (
                ...
                products.map(product => {
                  ...
                  return (
                    <div key={product.id} className={`border rounded-lg overflow-hidden hover:shadow-lg transition-shadow ${isInCart ? 'border-green-500 border-2' : ''}`}>
                      {isInCart && (
        ...
        {cart.length > 0 && (
          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
            ...
            <div className="p-6">
              ...
              {/* Totals and Complete Order Button */}
              <div className="mt-6 border-t pt-6">
